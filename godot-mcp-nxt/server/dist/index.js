...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var server, staticResources, resourceTemplates, cleanup;
        return __generator(this, function (_a) {
            ...
            // Register all tools
            __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], nodeTools, true), scriptTools, true), sceneTools, true), editorTools, true), cliTools, true), codeAnalysisTools, true), performanceTools, true).forEach(function (tool) {
                server.addTool(tool);
            });
            staticResources = [
                sceneListResource,
