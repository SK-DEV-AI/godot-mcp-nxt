...
export class ClientConfigManager {
     ...
     */
    static createCustomConfig(baseClient, customizations) {
     ...
     */
    static exportConfig(clientName) {
     ...
     */
    static importConfig(jsonConfig) {
        try {
...
ClientConfigManager.configs = new Map([
    ['claude', claudeConfig],
 ...
 */
export function generateSetupInstructions(clientName) {
...
//# sourceMappingURL=client_config_templates.js.map