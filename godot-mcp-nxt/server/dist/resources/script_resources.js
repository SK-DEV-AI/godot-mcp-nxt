 ...
 */
export var scriptContentTemplate = {
 ...
 */
export var currentScriptContentResource = {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        console.error('Error fetching current script content:', error_2);
                        throw error_2;
                    case 4: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_3 = _a.sent();
                        console.error('Error fetching script list:', error_3);
                        throw error_3;
                    case 4: return [2 /*return*/];
                }
            });
...
export var scriptMetadataResource = {
    ...
    load: function () {
        return __awaiter(this, void 0, void 0, function () {
            var godot, scriptPath, result, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        godot = getGodotConnection();
                    ...
                    case 3:
                        error_4 = _a.sent();
                        console.error('Error fetching script metadata:', error_4);
                        throw error_4;
                    case 4: return [2 /*return*/];
                }
            });
