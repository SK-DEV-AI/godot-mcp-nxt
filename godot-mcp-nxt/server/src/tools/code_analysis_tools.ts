 ...
 */
export const analyzeScriptTool: MCPTool = {
 ...
 */
export const compareScriptsTool: MCPTool = {
  ...
  execute: async ({ script_path_a, script_path_b, include_line_numbers }) => {
    ...
    try {
      ...
      const comparison = compareGDScriptFiles(
        resultA.content,
        resultB.content,
        script_path_a,
        script_path_b,
 ...
 */
export const codeMetricsTool: MCPTool = {
...
function analyzeGDScriptContent(content: string, filePath: string, includeHighlighting: boolean, checkStyle: boolean) {
  ...
  const analysis = {
    ...
    warnings: [] as any[],
    style_issues: [] as any[],
    syntax_highlighting: includeHighlighting ? [] as any[] : undefined
  };
...
function analyzeLineForHighlighting(line: string, lineNumber: number) {
  const highlights = [];
...
function compareGDScriptFiles(contentA: string, contentB: string, pathA: string, pathB: string, includeLineNumbers: boolean) {
...
function calculateCodeMetrics(content: string, filePath: string, includeComplexity: boolean) {
  const lines = content.split('\n');
...
export const codeAnalysisTools: MCPTool[] = [
  analyzeScriptTool,
  compareScriptsTool,
  codeMetricsTool
];