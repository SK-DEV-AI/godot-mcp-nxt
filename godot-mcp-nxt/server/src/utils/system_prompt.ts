...
`;
   ...
   */
  private static formatToolDescription(tool: any): string {
   ...
   */
  private static getCategoryUsageTips(category: string): string {
   ...
   */
  private static getCategoryPatterns(category: string): string {
