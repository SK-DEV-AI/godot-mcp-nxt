...
export class PerformanceBenchmarker {
  ...
  async runSuite(suite: PerformanceSuite): Promise<BenchmarkResult[]> {
...
let globalBenchmarker: PerformanceBenchmarker | null = null;

export function getBenchmarker(): PerformanceBenchmarker {
...
export function getRegressionDetector(): PerformanceRegressionDetector {
