 ...
 * Decompress data
 */
export async function decompressData(compressedData: CompressedData): Promise<string | Buffer> {
 ...
 */
export function shouldCompress(data: any, minSize: number = 1024): boolean {
...
export async function compressJsonResponse(
  data: any,
  options: CompressionOptions = {}
): Promise<{ data: any; compressionInfo?: CompressedData }> {
 ...
 */
export async function decompressJsonResponse(data: any): Promise<any> {
