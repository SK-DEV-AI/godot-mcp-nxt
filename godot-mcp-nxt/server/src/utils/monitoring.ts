...
export class MonitoringSystem {
  ...
  private async runHealthChecks(): Promise<void> {
    ...
    for (const checkKey of checkNames) {
      ...
      const checkFn = (this as any)[checkKey];
  ...
  private emitMetricsUpdate(metrics: SystemMetrics): void {
...
export async function createFilesystemHealthCheck(): Promise<HealthCheck> {
